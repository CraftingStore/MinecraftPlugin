...
import net.craftingstore.core.provider.PusherProvider;
import net.craftingstore.core.provider.SocketProvider;

public enum ProviderType {
    SOCKET(SocketProviderInformation.class, SocketProvider.class), PUSHER(PusherProviderInformation.class, PusherProvider.class);
